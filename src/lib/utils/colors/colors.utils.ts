...
export const dsColorsTokens = [
  {
    ...
    colors: [
      ...
      { name: 'bg-primary-lighter', value: '--color-neutral-300', white: false },
      { name: 'bg-primary-alpha-4', value: '--color-alpha-neutral-4', white: false },
      { name: 'bg-primary-alpha-8', value: '--color-alpha-neutral-8', white: false },
      { name: 'bg-primary-alpha-10', value: '--color-alpha-neutral-10', white: false },
      { name: 'bg-primary-alpha-16', value: '--color-alpha-neutral-16', white: false },
    ],
  },
  {
    name: 'static',
