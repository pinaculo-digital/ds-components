...
<button
  class="outline-soft-200 data-[active]:border-strong-950 data-[error]:border-error-base focus:border-strong-950 text-sub-600 disabled:text-sub-300 disabled:bg-weak-50 bg-white-0 flex w-full
