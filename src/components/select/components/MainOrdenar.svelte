...
<button
  class="outline-soft-200 data-[active]:border-strong-950 focus:border-strong-950 text-sub-600 disabled:text-disabled-300 disabled:bg-weak-50 bg-white-0 flex h-full w-full grow
